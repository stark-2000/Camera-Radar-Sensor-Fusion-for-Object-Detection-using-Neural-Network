...
def _radar_transformation(radar_data, height=None):
    ...
    radar_xyz_endpoint = np.zeros((3, num_points), dtype=np.float32)
...
if __name__ == '__main__':
    ...
    nusc = NuScenes(version='mini', dataroot='D:\ENPM809K\CameraRadarFusionNet-master\crfnet\data\mini', verbose=True)
